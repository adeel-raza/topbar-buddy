...
TopBar Buddy is a user-friendly WordPress plugin that lets you display beautiful banners on your website. Perfect for announcements, promotions, alerts, and important messages.

**Key Features:**

* **Free Date Scheduling** - Schedule banners with start and end dates using your WordPress site timezone (previously a Pro-only feature!)
